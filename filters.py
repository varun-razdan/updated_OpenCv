...
if not (os.path.exists("haarcascade_frontalface_default.xml")):
    haar_file = urllib.URLopener()
    haar_file.retrieve("https://raw.githubusercontent.com/opencv/opencv/master/data/haarcascades/haarcascade_frontalface_default.xml", "haarcascade_frontalface_default.xml")
